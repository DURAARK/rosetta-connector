...
public class DepositActivityWSTest {
	...
	static final String WSDL_URL = "http://localhost:1801/dpsws/deposit/DepositWebServices?wsdl"; // Change
	static final String PDS_URL = "http://il-dtldev04:8992/pds"; // Change
	...
	public static void main(String[] args) {
		...
		String userName = "TIB-DURAARK-Auto";
		String password = "9TCops!T#";
		String institution = "TIB";
...
//		System.out.println(services.getDepositActivityBySubmitDate(pdsHandle, "All", "10000", null, "20/01/2010", "20/12/2010", "1", "10"));
		...
		System.out.println("get all new MF - mine\n"+
				services.getDepositActivityBySubmitDateByMaterialFlow(pdsHandle, "All", "33980", "10000", null, "20/01/2010", "20/12/2010", "1", "30")
				);
		System.out.println("get standard MF - 1\n"+
				services.getDepositActivityBySubmitDateByMaterialFlow(pdsHandle, "All", "1", "10000", null, "20/01/2010", "20/12/2010", "1", "30")
				);

		System.out.println("get all MF \n"+
				services.getDepositActivityBySubmitDate(pdsHandle, "All", "10000", null, "20/01/2010", "20/12/2010", "1", "30")
				);
		try {
